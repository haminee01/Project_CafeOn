...
export default function CafeInfoSection({ cafe, onChatRoom, onShare, onSave, onWriteReview }: CafeInfoSectionProps) {
        ...
        <div className="space-y-6 w-3/4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                ...
                {cafe.hoursDetail.lastOrder && (
                  <span className="text-gray-900 ml-2">{cafe.hoursDetail.lastOrder} 라스트오더</span>
                )}
              <Button
                onClick={() => {
                ...
                <div className="space-y-2 text-sm">
                  ...
                  {cafe.hoursDetail.lastOrder && (
                    <div className="flex justify-between">
                      ...
                      <span className="text-gray-900">{cafe.hoursDetail.lastOrder}</span>
                    </div>
                  )}
                  <div className="flex justify-between">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <button 
              ...
              className="flex flex-col items-center justify-center border border-primary rounded-lg h-12 w-20 hover:bg-gray-50 transition-colors"
            >
              <svg className="w-5 h-5 text-primary mb-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
